...
AVAILABLE_INDICATOR_TABLES = [
    ...
    {"id": "research_areas_domain", "name": "Domains (Dominios - Nivel 1)", "icon": "🧭", "slug": "research_areas_domain"},
    {"id": "research_areas_field", "name": "Fields (Campos - Nivel 2)", "icon": "🔬", "slug": "research_areas_field"},
    {"id": "research_areas_subfield", "name": "Subfields (Subcampos - Nivel 3)", "icon": "🏷️", "slug": "research_areas_subfield"},
    {"id": "research_areas_topic", "name": "Topics (Tópicos - Nivel 4)", "icon": "🔍", "slug": "research_areas_topic"},
    {"id": "research_areas_sdg", "name": "Research Areas SDG (ODS)", "icon": "🎯", "slug": "research_areas_sdg"},
    {"id": "concepts", "name": "Concepts (Conceptos)", "icon": "💡", "slug": "concepts"},
    {"id": "keywords", "name": "Keywords (Palabras Clave)", "icon": "🏷️", "slug": "keywords"},
...
TABLE_SLUG_MAP = {
    ...
    # Taxonomía Nivel 1 (Domain)
    "domain": "research_areas_domain",
    "domains": "research_areas_domain",
    "macro_topics": "research_areas_domain",
    "research_areas_domain": "research_areas_domain",
    "research_areas_macro_topics": "research_areas_domain",
    # Taxonomía Nivel 2 (Field)
    "field": "research_areas_field",
    "fields": "research_areas_field",
    "meso_topics": "research_areas_field",
    "research_areas_field": "research_areas_field",
    "research_areas_meso_topics": "research_areas_field",
    # Taxonomía Nivel 3 (Subfield)
    "subfield": "research_areas_subfield",
    "subfields": "research_areas_subfield",
    "research_areas_subfield": "research_areas_subfield",
    "esi": "research_areas_subfield",
    "research_areas_esi": "research_areas_subfield",
    # Taxonomía Nivel 4 (Topic)
    "topic": "research_areas_topic",
    "topics": "research_areas_topic",
    "micro_topics": "research_areas_topic",
    "research_areas_topic": "research_areas_topic",
    "research_areas_micro_topics": "research_areas_topic",
    # SDG / ODS
    "sdg": "research_areas_sdg",
    "sdgs": "research_areas_sdg",
    "research_areas_sdg": "research_areas_sdg",
    # Conceptos, Keywords y APC
    "concepts": "concepts",
    "keywords": "keywords",
...
routes = [
    ...
    Route('/api/citations/referenced-works/{package_name}', get_referenced_works_endpoint, methods=['GET']),
    Route('/api/citations/work-references/{work_id:path}', get_single_work_references_endpoint, methods=['GET']),
